...
// utils
import { fDate, getMethod, postMethod, fTurkishPercent } from "src/utils";
...
const TABLE_HEAD = [
  ...
  {
    id: "Ses Kaydetme Sayısı",
    name: "number_of_voice_recordings",
    label: "Ses Kaydetme Sayısı",
    alignRight: false,
  },
  {
    id: "Başarı Yüzdesi",
  ...
  {
    id: "Toplam Süre",
    name: "total_login_timing",
    label: "Toplam Süre",
    alignRight: false,
  },
];

const ReportFilterTable = (props) => {
  const { t } = props;
  ...
  const handleExportExcel = () => {
    exportFile(API_URL.GET_CLASS_REPORT_TASK_CSV, "task", true);
  };
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          {row?.number_of_readings}
                        </TableCell>
                        <TableCell align="left">
                          {row?.number_of_listens}
                        </TableCell>
                        <TableCell align="left">
                          {row?.number_of_events}
                        </TableCell>
                        <TableCell align="left">
                          {row?.number_of_voice_recordings}
                        </TableCell>
                        <TableCell align="left">
                          {fTurkishPercent(row?.success_percentage)}
                        </TableCell>
                        <TableCell align="left">
                          {fDate(row?.last_login, "DD.MM.yyyy")}
                        </TableCell>
                        <TableCell align="left">{row?.total_login}</TableCell>
                        <TableCell align="left">
                          {row?.total_login_timing}
                        </TableCell>
                      </StyledTableRow>
                    );
                  })}
